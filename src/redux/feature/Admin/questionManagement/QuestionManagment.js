...
export const getAllQuestion = createAsyncThunk('questions/getAll', async (data, { rejectWithValue }) => {
    try {
...
export const paginaTion = createAsyncThunk('questions/paginate', async (data, { rejectWithValue }) => {
    try {
        const response = await getAllQuestions(data)
        return response.data
    } catch (err) {
...
export const approveQuestion = createAsyncThunk('questions/approve', async (data, { rejectWithValue }) => {
    try {
...
export const rejectQuestion = createAsyncThunk('questions/reject', async (data, { rejectWithValue }) => {
    try {
...
export const { resetQuestions } = usersSlice.actions
